        ...
        buttonSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(floatEditText.getFloatValue() > 0){
                    ...
                    it.putExtra("cep", getIntent().getStringExtra("cep"));
                    it.putExtra("numero_residencia", getIntent().getStringExtra("numero_residencia"));
                    it.putExtra("cidade_uf", getIntent().getStringExtra("cidade_uf"));
                    it.putExtra("telefone", getIntent().getStringExtra("telefone"));
