...
import app.cloudcrm.tech.cloudcrm.activities.CepActivity;
...
import static app.cloudcrm.tech.cloudcrm.activities.CepActivity.formatCep;
...
public class FormularioAdapter extends ArrayAdapter<Campo>{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (tipo) {
            ...
            case Formulario.TYPE_PHONE:
                ...
                break;
            case Formulario.TYPE_CEP:
                viewHolder = new ViewHolderCep();
                break;
    ...
    class ViewHolderPicture extends BaseViewHolder{
        ...
        public void bindUI(final View convertView) {
            ...
            buttonImageDownload.setOnClickListener(new View.OnClickListener() {
                ...
                final File fl = new File(thumbnailFolder+String
                        .valueOf(formulario.getRemoteId())+"_"+String.valueOf(campo.getTipo().getTipo())+"_"+campo.getId()+"_"+String.valueOf(myEntry.getId())+".jpg");
                        ...
                        try {
                            ...
                            if(data.startsWith("https://")){
                                ...
                                if(downloading){
                                    ...
                                    return;
                                }else ((Activity) getContext()).runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Uri uri = FileProvider.getUriForFile(
                            getContext(),
                            "app.cloudcrm.tech.cloudcrm.fileprovider",
                            f);
                    ...
                    ((Activity)getContext()).grantUriPermission("app.cloudcrm.tech.cloudcrm.fileprovider", uri, Intent.FLAG_GRANT_READ_URI_PERMISSION);
    ...
    class ViewHolderCep extends BaseViewHolder{
        ...
        public void bindUI(View convertView) {
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent it = new Intent((Activity)getContext(),CepActivity.class);
                    ...
                    ((Activity)getContext()).startActivityForResult(it, 5410);
        ...
        public void loadData(Campo campo) {
            ...
            if (formularioData.has(campo.getId())) {
                ...
                try {
                    ...
                    button.setText(formatCep(val));

                    if(val.equals("")){
                        button.setText("Digitar Cep");
                    }
                    ...
                    if (formularioData.has(text1)) {
                        ...
                        if (existe == false) {
                            ...
                            try {
                                ...
                                if (formularioData.has("phone1")) {
                                    phone1 = formularioData.getString("phone1");
                                }
                                if (formularioData.has("cidade1")) {
                                    cidade1 = formularioData.getString("cidade1");
                                }
                                if (formularioData.has("int1")) {
                                    int1 = formularioData.getString("int1");
                                }
                                if (formularioData.has("cep1")) {
                                    cep1 = formularioData.getString("cep1");
                                }
                                it.putExtra("documento", cpf1);
                                it.putExtra("telefone", phone1);
                                it.putExtra("cidade_uf", cidade1);
                                it.putExtra("numero_residencia", int1);
                                it.putExtra("cep", cep1);
    ...
    public class ViewHolderSaveSend extends BaseViewHolder{
        Button buttonSave;
        Button buttonSend;
        Button buttonDownloadPDF;//adicionado por thiago
        @Override
        public void bindUI(View convertView) {
            buttonSave = (Button) convertView.findViewById(R.id.text);
            ...
            ABAIXO:
             */
            buttonDownloadPDF = (Button) convertView.findViewById(R.id.buttonDownloadPDF);
            buttonDownloadPDF.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    try {
                        ...
                        jsonObject.put("email", "downloadPDF");
                        jsonObject.put("nome", "downloadPDF");
                        ((FormularioActivity)getContext())
                                .getForm().getData().put("send_to", jsonObject);
                    ...
                    myEntry.setJson( ((FormularioActivity)getContext()).getForm().getData().toString());
                            ...
                            public void onSuccess(final JSONObject result) {
                                ...
                                ((FormularioActivity)getContext()).runOnUiThread(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        try {
                                            //pegar resposta do rest (url do PDF)
                                            final String url = result.getJSONObject("data").getJSONObject("send_to").getString("nome");
                                            Log.d("UPLOAD","url= " + url);

                                            Toast.makeText((getContext()), url, Toast.LENGTH_LONG).show();
                                            final String url2 = "http://cloud.cloudcrm.tech/" + url.replace("/var/www/","");
                                            Log.d("UPLOAD","url2= " + url2);

                                            //baixar o PDF e salvar em downloads do cel
                                            if (url.compareTo("downloadPDF") != 0){
                                                //abrir dialog com o link e botao de copiar!!
                                                final AlertDialog alertDialog = new AlertDialog.Builder(getContext()).create();
                                                alertDialog.setTitle("PDF Criado!");
                                                ...
                                                /* Edited By Gustavo Junior */

                                                final String FormName;
                                                final String data;

                                                FormName = App.formularios.queryForEq("remoteId", formulario.getRemoteId()).get(0).getNome();
                                                data = App.getCurrentUser().getCompanyName() + " - " + FormName+ " :\n" + url2 ;

                                                /* ------------------------ */

                                                alertDialog.setButton(AlertDialog.BUTTON_NEUTRAL, "COPIAR e FECHAR",
                                                        new DialogInterface.OnClickListener() {
                                                            public void onClick(DialogInterface dialog, int which) {
                                                                ClipboardManager clipboard = (ClipboardManager) getContext().getSystemService(Context.CLIPBOARD_SERVICE);
                                                                ClipData clip = ClipData.newPlainText("url", url2);
                                                                clipboard.setPrimaryClip(clip);
                                                                alertDialog.dismiss();
                                                            }
                                                        });

                                                alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "COMPARTILHAR",
                                                        new DialogInterface.OnClickListener() {
                                                            public void onClick(DialogInterface dialog, int which) {
                                                                ...
                                                                (getContext()).startActivity(Intent.createChooser(sendIntent, "Compartilhar:"));

                                                            }
                                                        });

                                                alertDialog.setButton(AlertDialog.BUTTON_NEGATIVE, "ABRIR",
                                                        new DialogInterface.OnClickListener() {
                                                            public void onClick(DialogInterface dialog, int which) {
                                                ...
                                                //new DownloadTask(getContext(), url2 );
//                                                new DownloadFile().execute("http:/cloud.cloudcrm.tech/" + url,
//                                                                           url,
//                                                                           getContext().getDir("cloudCRM_pdfs", Context.MODE_PRIVATE).getAbsolutePath()
//                                                );
                                            }else
                                                Toast.makeText((getContext()), "Muitas tentativas.. PDF nao criado.. ", Toast.LENGTH_LONG).show();
                                        }catch (Exception e){
                            ...
                            public void onError(Exception e) {
                                Toast.makeText(((FormularioActivity)getContext()), "Erro ao baixar PDF...", Toast.LENGTH_SHORT).show();
                    ...
                    ((FormularioActivity)getContext()).sendBroadcast(it);
                }
            });
            /*
            ACIMA:
